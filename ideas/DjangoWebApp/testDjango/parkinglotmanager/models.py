...
class Cameralist(models.Model):
    ...
    parkinglotid = models.ForeignKey('Parkinglotlist', models.DO_NOTHING, db_column='parkinglotid', blank=True, null=True)
...
class History(models.Model):
    ...
    staffid = models.ForeignKey('Stafflist', models.DO_NOTHING, db_column='staffid', blank=True, null=True)
    cameraid = models.ForeignKey(Cameralist, models.DO_NOTHING, db_column='cameraid', blank=True, null=True)
    inorout = models.BooleanField(blank=True, null=True)
...
class Parking(models.Model):
    ...
    parkinglotid = models.ForeignKey('Parkinglotlist', models.DO_NOTHING, db_column='parkinglotid')
    platenumber = models.CharField(max_length=15, blank=True, null=True)
    plateimgurl = models.CharField(max_length=255, blank=True, null=True)
